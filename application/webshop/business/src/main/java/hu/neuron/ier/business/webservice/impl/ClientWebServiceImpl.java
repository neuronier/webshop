...
@WebService(name = "ClientWebServicePort", serviceName = "ClientWebService", targetNamespace = "http://hu.neuron", endpointInterface = "hu.neuron.ier.business.webservice.ClientWebService")
